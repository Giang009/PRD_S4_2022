...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Approval_Rework_of_Rework recording.
    /// </summary>
    [TestModule("592723d8-0875-45cf-bef8-44534ae5e538", ModuleType.Recording, 1)]
    public partial class Approval_Rework_of_Rework : ITestModule
    {
        /// <summary>
        ...
        static Approval_Rework_of_Rework instance = new Approval_Rework_of_Rework();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Approval_Rework_of_Rework()
        {
            varCR_Number = "";
        }
        ...
        /// </summary>
        public static Approval_Rework_of_Rework Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("dd6e46ea-c13c-44a7-8dd6-741ad8c098be")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SimpleMDG.Approval.btn_Rework_of_Rework' at Center.", repo.SimpleMDG.Approval.btn_Rework_of_ReworkInfo, new RecordItemIndex(13));
            repo.SimpleMDG.Approval.btn_Rework_of_Rework.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SimpleMDG.Approval.btn_Rework_by_Requestor' at Center.", repo.SimpleMDG.Approval.btn_Rework_by_RequestorInfo, new RecordItemIndex(14));
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'AT Ranorex Approval with Rework a Duplication CR' with focus on 'SimpleMDG.Approval.txt_Comment_Approval'.", repo.SimpleMDG.Approval.txt_Comment_ApprovalInfo, new RecordItemIndex(16));
            repo.SimpleMDG.Approval.txt_Comment_Approval.PressKeys("AT Ranorex Approval with Rework a Duplication CR");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SimpleMDG.Approval.btn_Rework_Confirm' at Center.", repo.SimpleMDG.Approval.btn_Rework_ConfirmInfo, new RecordItemIndex(17));

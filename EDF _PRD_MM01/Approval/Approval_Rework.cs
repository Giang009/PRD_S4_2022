...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Approval_Rework recording.
    /// </summary>
    [TestModule("a5ad3c6b-0c36-4ec0-ad36-1503fa6b8944", ModuleType.Recording, 1)]
    public partial class Approval_Rework : ITestModule
    {
        /// <summary>
        ...
        static Approval_Rework instance = new Approval_Rework();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Approval_Rework()
        {
            varCR_Number = "";
        }
        ...
        /// </summary>
        public static Approval_Rework Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("a233bb91-c09d-4940-9955-31edea09b2e6")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SimpleMDG.Approval.btn_Rework' at Center.", repo.SimpleMDG.Approval.btn_ReworkInfo, new RecordItemIndex(11));
            repo.SimpleMDG.Approval.btn_Rework.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SimpleMDG.Approval.btn_Rework_by_Requestor' at Center.", repo.SimpleMDG.Approval.btn_Rework_by_RequestorInfo, new RecordItemIndex(12));
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'AT Ranorex Approval with Rework a Duplication CR' with focus on 'SimpleMDG.Approval.txt_Comment_Approval'.", repo.SimpleMDG.Approval.txt_Comment_ApprovalInfo, new RecordItemIndex(14));
            repo.SimpleMDG.Approval.txt_Comment_Approval.PressKeys("AT Ranorex Approval with Rework a Duplication CR");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SimpleMDG.Approval.btn_Rework_Confirm' at Center.", repo.SimpleMDG.Approval.btn_Rework_ConfirmInfo, new RecordItemIndex(15));

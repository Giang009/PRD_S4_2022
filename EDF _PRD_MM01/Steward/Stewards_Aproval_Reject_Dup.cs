...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Stewards_Aproval_Reject_Dup recording.
    /// </summary>
    [TestModule("94deec05-79b7-4dd1-81e4-4a0767ef8079", ModuleType.Recording, 1)]
    public partial class Stewards_Aproval_Reject_Dup : ITestModule
    {
        /// <summary>
        ...
        static Stewards_Aproval_Reject_Dup instance = new Stewards_Aproval_Reject_Dup();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Stewards_Aproval_Reject_Dup()
        {
            varCR_Number = "";
        }
        ...
        /// </summary>
        public static Stewards_Aproval_Reject_Dup Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("56e1e75b-a1ec-4dd8-8472-6e432cb87dca")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 10s to exist. Associated repository item: 'SimpleMDG.Stewards.lb_Status_ASSIGNED'", repo.SimpleMDG.Stewards.lb_Status_ASSIGNEDInfo, new ActionTimeout(10000), new RecordItemIndex(15));
            repo.SimpleMDG.Stewards.lb_Status_ASSIGNEDInfo.WaitForExists(10000);
            
            Report.Log(ReportLevel.Info, "Wait", "Waiting 10s to exist. Associated repository item: 'SimpleMDG.Stewards.btn_menu_Option'", repo.SimpleMDG.Stewards.btn_menu_OptionInfo, new ActionTimeout(10000), new RecordItemIndex(16));
            repo.SimpleMDG.Stewards.btn_menu_OptionInfo.WaitForExists(10000);
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 10s to exist. Associated repository item: 'SimpleMDG.Stewards.lb_Status_DUPLICATE'", repo.SimpleMDG.Stewards.lb_Status_DUPLICATEInfo, new ActionTimeout(10000), new RecordItemIndex(22));
            repo.SimpleMDG.Stewards.lb_Status_DUPLICATEInfo.WaitForExists(10000);
            
            Report.Log(ReportLevel.Info, "Wait", "Waiting 10s to exist. Associated repository item: 'SimpleMDG.Stewards.btn_menu_Option'", repo.SimpleMDG.Stewards.btn_menu_OptionInfo, new ActionTimeout(10000), new RecordItemIndex(23));
            repo.SimpleMDG.Stewards.btn_menu_OptionInfo.WaitForExists(10000);
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SimpleMDG.Stewards.mn_Reject' at Center.", repo.SimpleMDG.Stewards.mn_RejectInfo, new RecordItemIndex(25));
            repo.SimpleMDG.Stewards.mn_Reject.Click();
            Delay.Milliseconds(0);
            
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SimpleMDG.Stewards.btn_OK_Confirm' at Center.", repo.SimpleMDG.Stewards.btn_OK_ConfirmInfo, new RecordItemIndex(26));
            //repo.SimpleMDG.Stewards.btn_OK_Confirm.Click();
            //Delay.Milliseconds(0);

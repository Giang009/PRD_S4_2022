...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Verify_CR_Status_After_Rework_Steward recording.
    /// </summary>
    [TestModule("9b953680-9b05-4627-807b-f6563f11113b", ModuleType.Recording, 1)]
    public partial class Verify_CR_Status_After_Rework_Steward : ITestModule
    {
        /// <summary>
        ...
        static Verify_CR_Status_After_Rework_Steward instance = new Verify_CR_Status_After_Rework_Steward();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Verify_CR_Status_After_Rework_Steward()
        {
            varCR_Number = "";
        }
        ...
        /// </summary>
        public static Verify_CR_Status_After_Rework_Steward Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("745a065f-d143-44a6-9c2c-db0455a2b432")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (innertext='REWORKED') on item 'SimpleMDG.Copy_CR.lb_Status_REWORKED'.", repo.SimpleMDG.Copy_CR.lb_Status_REWORKEDInfo, new RecordItemIndex(9));
            Validate.AttributeEqual(repo.SimpleMDG.Copy_CR.lb_Status_REWORKEDInfo, "innertext", "REWORKED");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (innertext='REWORKED') on item 'SimpleMDG.Copy_CR.lb_Active_Status_REWORKED'.", repo.SimpleMDG.Copy_CR.lb_Active_Status_REWORKEDInfo, new RecordItemIndex(10));
            Validate.AttributeEqual(repo.SimpleMDG.Copy_CR.lb_Active_Status_REWORKEDInfo, "innertext", "REWORKED");
            Delay.Milliseconds(0);

...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Verify_CR_Status_After_DUPLICATED_Steward recording.
    /// </summary>
    [TestModule("a4a33338-8fda-4221-a895-3e3a0f1c0454", ModuleType.Recording, 1)]
    public partial class Verify_CR_Status_After_DUPLICATED_Steward : ITestModule
    {
        /// <summary>
        ...
        static Verify_CR_Status_After_DUPLICATED_Steward instance = new Verify_CR_Status_After_DUPLICATED_Steward();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Verify_CR_Status_After_DUPLICATED_Steward()
        {
            varCR_Number = "";
        }
        ...
        /// </summary>
        public static Verify_CR_Status_After_DUPLICATED_Steward Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("bfc74266-1e17-45a5-b36c-7caac0d17508")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (innertext='DUPLICATED') on item 'SimpleMDG.Copy_CR.lb_Active_Status_DUPLICATED'.", repo.SimpleMDG.Copy_CR.lb_Active_Status_DUPLICATEDInfo, new RecordItemIndex(6));
            Validate.AttributeEqual(repo.SimpleMDG.Copy_CR.lb_Active_Status_DUPLICATEDInfo, "innertext", "DUPLICATED");
            Delay.Milliseconds(0);
